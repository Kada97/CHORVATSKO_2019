<?php
    ...
    function dbRecountMoney($usersToRecount) {
        ...
        for ($i = 0; $i < count($usersToRecount); $i++) {
            ...
            $money_extra_ig_total           += $money_extra_ig_cl + $money_extra_ig_dk;
            $money_extra_tg_total           += $money_extra_tg_cpt + $money_extra_tg_cl + $money_extra_tg_dk;
            $money_extra_total              += $money_extra_tg_total + $money_extra_ig_total + $money_extra_web_total + $money_extra_qr_total + $money_extra_clean_balance;
            ...
            $money_total_received           += $money_received + $money_tg_received + $money_extra_total;
