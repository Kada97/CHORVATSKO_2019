<?php
    ...
    $get = mysqli_query($conn, "SELECT * FROM users WHERE username ='".$_SESSION["username"]."';");
    ...
    echo'
		...
		<div class="profileHeaderRow"><a href="com.google.zxing.client.android.apk">QR čtečka ke stažení</a><hr><br></div>
		...
		';
		if($_SESSION["username"] == $allResult['username']){
		    echo'<div class="profileHeaderRow"><label>Verifikační kód: </label>'.$allResult['verification'].'<br><hr></div>';
		}
    echo'
